...
- [ ] Data Export/Import (Dump & Restore) (Est: 1.5h | Act: Pending)
...
gantt
    ...
    section Phase 2: Images (Est 2h | Act 45m)
    Artifact Registry & Push    :done, p2, after p1, 45m
    section Phase 3: Infra (Est 5h | Act 20m)
    Native K8s Databases        :done, p3, after p2, 20m
    Data Export/Import          :active, p3b, after p3, 90m
    section Phase 4: Network (Est 4h | Act 10m)
    Ingress & Load Balancer     :done, p4, after p3, 10m
    section Phase 5: Deploy (Est 2h | Act 15m)
    Deployment & Validation     :done, p5, after p4, 15m
    section Phase 6: CI/CD (Est 3h | Act 15m)
    GitHub Actions Pipeline     :done, p6, after p5, 10m
    Cost Optimisation           :done, p7, after p6, 5m
```

...
- [ ] 🧪 **Testing Infrastructure**: Transition from legacy `Karma/Jasmine` to `Vitest` for ultra-fast TDD cycles and native Vite integration - **In Progress**.
- [x] 🧪 **Unit Tests Overhaul**: Align TDD suite with Angular v18 Signals and Control Flow.

...
- [x] **Mobile Responsiveness**:
    - [ ] Fix Navbar overlap where toolbar items collide with page titles (Ongoing).
    - [x] Correct layout stacking for form inputs on screens < 768px.
    - [x] Add horizontal padding to cards for mobile view.
- [ ] **UX Polish**: Improve visibility of "zoom" and "reset" instructions for the interactive chart.

## General Dashboard
- [ ] Fix potential 3D hover interference with child button click events.
- [ ] Standardize card heights for consistency across all measure sections.
